...
import profile from "../../assets/images/ajhar_rimon.png";
import "./About.css";
        ...
        <div className="flex flex-col lg:flex-row p-4 justify-center items-center gap-10 w-full mb-32">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="text-center lg:text-left w-full my-4">
              ...
              >
                Passionate web app developer.And I can build your website as you want.
                <br />
                <br />
                Always try to grab the new features of technology. Last few years made myself skilled in the field of web application development. Acquired to maintain strong interpersonal relationships with teammates.{" "}
              </p>
            </div>
            <div className="my-4">
              ...
              <div>
                Email: ajharrimon90@gmail.com <br /> Phone: +8801639076052{" "}
